...
> = {
  ...
  "Jr Vuejs Developer": {
    ...
    Rule 3. Candidate should have maximum salary of 50,000 per month or 10LPA per year. If candidates salary is not mentioned, assume he passes this criteria.
    Rule 4. Candidate should not have more than 1year of Experience.
  ...
  "Jr NodeJs Developer": {
    ...
    full_criteria: `-Rule 1. Candidate should have maximum salary of 50,000 per month or 10LPA per year. If candidates salary is not mentioned, assume he passes this criteria.
  ...
  "Jr Python Developer": {
    ...
    full_criteria: `
    - Rule 1. Candidate should have maximum salary of 50,000 per month or 10LPA per year. If candidates salary is not mentioned, assume he passes this criteria.

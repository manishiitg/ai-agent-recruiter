...
> = {
  ...
  "Jr NodeJs Developer": {
    ...
    questions_to_ask: [
      ...
      `technical question related to expressjs and rest apis`,
      `assume there is an array on integers and we need to find the nth largest element in the array. what would be your approach to find this. don't use sorting, need to use for loops and solve this problem. let me know what be your approach`,
